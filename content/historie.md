...
Dreidimensionale Formen waren ebenfalls darstellbar. Der Bildschirm konnte in vier  Teilfenster (Draufsicht, Seitenansicht, Frontalansicht und Dreidimensionale Darstellung) aufgeteilt werden. Die Manipulation des Objektes oder das Zeigen auf ein Teil des Objektes in einer der Ansichten, wurde simultan auf alle Ansichten übertragen.^[Ivan Sutherland : Sketchpad Demo - bigkif / YouTube [Teil 1](https://youtu.be/USyoT_Ha_bA), [Teil 2](https://youtu.be/BKM3CmRqK2o)]
<!-- XXXX Snapping -->
...
Anhand einer beispielhaften Einkaufsliste zeigt er, wie Verlinkungen (Hyperlinks) innerhalb des Dokuments erstellt werden können, und wie sich mit Hilfe dieser auch Grafiken mit Text verknüpfen lassen. Er demonstriert die Erstellung von  'Ansichtsketten' und veranschaulicht die Nützlichkeit von Hyperlinks, die das 'Springen' zwischen verschiedenen Ansichten ermöglichen. Ziel des _NLS (oN-Line-System)_ genannten Systems war es, die Handhabung von komplexen Informationsstrukturen zu vereinfachen. Inhalte sollten einfach zu verfassen, erfassen und zu modifizieren sein. Die Struktur von Daten wird erstmals nicht linear, sondern dem menschlichen Denken nachempfunden und _netzartig_ aufgebaut. Das NLS gilt neben _Plato_^[[platohistory.org](http://www.platohistory.org/)] als einer der wichtigsten Vorfahren des heutigen Internets. 
